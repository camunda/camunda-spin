 ...
 *
 */
public class JakartaDomXmlDataFormatMapper implements DataFormatMapper {

  protected JakartaDomXmlDataFormat dataFormat;

  private static final DomXmlLogger LOG = DomXmlLogger.XML_DOM_LOGGER;

  public JakartaDomXmlDataFormatMapper(JakartaDomXmlDataFormat format) {
  ...
  protected Marshaller getMarshaller(Class<?> parameter) throws JAXBException {
    JakartaJaxBContextProvider jaxBContextProvider = dataFormat.getJaxBContextProvider();
